...
const VIDEOS_DEMO: VideoType[] = [
  {
    id: "pGXLrXnhXL8",
    title: "Découvrez TripNest : Votre Solution de Location Ultime en Algérie",
    thumbnail:
      "/images/thumb/tripnest-thumbnail.png",
  },
  {
    id: "a5V6gdu5ih8",
...
const SectionVideos: FC<SectionVideosProps> = ({
  ...
  const renderSubVideo = (video: VideoType, index: number) => {
    ...
    return (
      <div
        className="group relative aspect-video rounded-2xl cursor-pointer overflow-hidden sm:rounded-3xl will-change-transform"
        onClick={() => {
